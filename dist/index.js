...
var runRsbuildDevServer = function (options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, core.loadConfig(options)];
            case 1:
                _a = _b.sent(), rsbuildConfig = _a.content, filePath = _a.filePath;
                return [4 /*yield*/, core.createRsbuild({
                        cwd: options.cwd,
                        rsbuildConfig: rsbuildConfig,
                    })];
            case 2:
                rsbuild = _b.sent();
                return [4 /*yield*/, rsbuild.startDevServer()];
            case 3:
                devServer = _b.sent();
                return [2 /*return*/, { rsbuild: rsbuild, devServer: devServer, filePath: filePath }];
        }
    });
}); };
function run() {
    ...
    devCommander.action(function (options) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, runRsbuildDevServer({
                        cwd: process.cwd(),
                        path: options.config,
